...
const Footer = () => {
  ...
  return (
    ...
    >
      {/* Newsletter Section */}
      <section className="ml-70 py-10 px-4 sm:px-6 lg:px-8 text-center border-b border-gray-800">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-wide mb-2 flex items-center justify-center gap-2">
            SHEIKH NABEEL
            <span className="text-green-500"></span>
          </h2>
          <p className="text-lg font-bold mb-7 text-gray-300 max-w-md mx-auto leading-tight">
      ...
      <div className="flex justify-center flex-wrap gap-4 py-8 ml-70 ">
        ...
        {/* Instagram Gradient */}
        <a href="#" className="w-12 h-12 rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex items-center justify-center">
          <svg className="w-6 h-6" fill="white" viewBox="0 0 24 24">
