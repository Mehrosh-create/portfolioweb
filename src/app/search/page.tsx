...
export default function Search() {
  ...
  return (
    <div className="min-h-screen bg-[#151515] text-white pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 xl:px-4 pb-8 sm:pb-12 lg:pb-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8 lg:mb-12">
          ...
          {/* Search description */}
          <p
            className="text-sm sm:text-base lg:text-lg text-gray-300 max-w-2xl"
            style={{
        ...
        {/* Search Results */}
        <div className="bg-[#252525] rounded-lg border border-gray-700 p-4 sm:p-6 lg:p-8">
          <div className="text-center py-8 sm:py-12 lg:py-16">
            ...
            <p
              className="text-sm sm:text-base lg:text-lg text-gray-300 max-w-md mx-auto mb-6 sm:mb-8"
              style={{
                fontFamily: 'Arial, "Helvetica Neue", Helvetica, sans-serif',
              }}
            >
          ...
          {searchQuery && (
            <div className="mt-6 sm:mt-8 border-t border-gray-700 pt-6 sm:pt-8">
              <h3
                className="text-base sm:text-lg lg:text-xl font-bold text-white mb-4 sm:mb-6"
                style={{
                  fontFamily: 'Arial, "Helvetica Neue", Helvetica, sans-serif',
                }}
              >
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="bg-[#1a1a1a] rounded-lg p-4 sm:p-6 border border-gray-700 hover:border-[#0fb8af] transition-all duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4
                        className="text-sm sm:text-base lg:text-lg font-bold text-white mb-2"
                        style={{
                          fontFamily: 'Arial, "Helvetica Neue", Helvetica, sans-serif',
                        }}
                      >
        ...
        <div className="mt-8 sm:mt-12 text-center sm:text-left">
          <button
            onClick={() => router.back()}
            className="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gray-800 hover:bg-gray-700 text-white rounded-lg transition-all duration-300 border border-gray-700 hover:border-gray-600 text-sm sm:text-base"
            style={{
              fontFamily: 'Arial, "Helvetica Neue", Helvetica, sans-serif',
            }}
          >
